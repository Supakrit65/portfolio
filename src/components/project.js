      ...
      <section className="bg-slate-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-slate-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          <div className="flex flex-row items-center gap-x-2">
            ...
            <a
              href={sourceURL}
              className="ml-2 transition-transform duration-300 ease-in-out hover:scale-110 focus:scale-110 active:scale-95"
            >
              <FaGithub size={20} />
            </a>
          </div>
          <p className="mt-2 leading-relaxed text-slate-700 dark:text-white/70 mb-2">
            {description}
          </p>
